    ...
    <div className="space-y-20 pb-20 overflow-x-hidden">
      ...
      <section className="relative pt-6 pb-12 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          {/* Right Column - Beautiful Romantic Proposal Spotlight Card */}
          <div className="lg:col-span-5 relative">
            <div className="glass-card bg-white/90 dark:bg-slate-800/90 rounded-3xl p-6 border border-slate-200 dark:border-slate-700 shadow-2xl space-y-5 max-w-md mx-auto">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5] shadow-md group">
                <img
                  src="/images/romantic_proposal_couple.jpg"
                  alt="Romantic Proposal Story"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex flex-col justify-end p-6 text-white">
                  <div className="flex items-center gap-1.5 mb-2">
                    <span className="px-2.5 py-0.5 rounded-full bg-rose-500/90 text-white font-extrabold text-[10px] uppercase shadow-md flex items-center gap-1">
                      <Heart className="w-3 h-3 fill-white" /> Success Story Proposal
                    </span>
                    <span className="text-[10px] font-bold text-amber-300">99.4% Match Rate</span>
                  </div>

                  <h3 className="text-2xl font-black tracking-tight text-white leading-tight">
                    "From First Date to Dream Proposal in 8 Months"
                  </h3>

                  <p className="text-xs text-slate-200 mt-1 line-clamp-2">
                    "Prateek Mhaisane guided us through communication traps, pre-marital background due diligence, and authentic attachment building."
                  </p>

                  <div className="flex items-center gap-2 mt-3 text-[11px] font-semibold text-slate-300 border-t border-white/20 pt-3">
                    <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                    <span>Coached & Verified by Founder Prateek Mhaisane</span>
                  </div>
                </div>
              </div>

              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-gradient-to-r from-rose-50 to-indigo-50 dark:from-rose-950/50 dark:to-indigo-950/50 border border-rose-100 dark:border-rose-900/30">
                <div>
                  <span className="text-[10px] uppercase font-bold text-rose-600 dark:text-rose-400">1-on-1 Consultation</span>
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs font-extrabold text-white gradient-bg shadow-md hover:opacity-90 transition-opacity"
                >
                  Start Your Story
                </button>
              </div>
